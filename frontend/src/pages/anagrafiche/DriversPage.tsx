...
export default function DriversPage() {
  ...
  const columns: DataTableColumn[] = [{ key: 'cognome', label: 'Cognome' }, { key: 'nome', label: 'Nome' }, { key: 'patente', label: 'Patente' }, { key: 'telefono', label: 'Telefono' }, { key: 'actions', label: '', className: 'w-20' }];
