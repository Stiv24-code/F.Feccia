...
export default function LocationCombobox({ value, onChange, options, placeholder, searchPlaceholder, icon: Icon, iconBg, iconColor }) {
          ...
          <span className="min-w-0 flex-1">
            {selected ? (
              <>
                ...
                {selected.indirizzo && <span className="block truncate text-xs text-muted-foreground">{selected.indirizzo}</span>}
              </>
            ) : (
              ...
              {options.map(o => (
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    {o.indirizzo && <span className="block truncate text-xs text-muted-foreground">{o.indirizzo}</span>}
                  </span>
